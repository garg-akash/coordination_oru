...
public abstract class TrajectoryEnvelopeTrackerFromData extends AbstractTrajectoryEnvelopeTracker implements Runnable {
	...
	public TrajectoryEnvelopeTrackerFromData(TrajectoryEnvelope te, int timeStep, double temporalResolution, TrajectoryEnvelopeCoordinator tec, TrackingCallback cb) {
	...
	public TrajectoryEnvelopeTrackerFromData(TrajectoryEnvelope te, int timeStep, double temporalResolution, double maxVelocity, double maxAcceleration, TrajectoryEnvelopeCoordinator tec, TrackingCallback cb) {
